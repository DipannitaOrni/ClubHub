...
import 'manager_events.dart';
import 'manager_members.dart';
...
class _ManagerDashboardState extends State<ManagerDashboard> {
  ...
  Future<void> _loadClubData() async {
    ...
    if (authProvider.currentUser != null) {
      await dataProvider.loadClub(authProvider.currentUser!.uid);
    }
  }
          ...
          child: BottomNavigationBar(
            ...
            items: [
              ...
              BottomNavigationBarItem(
                ...
                activeIcon: _buildNavIcon(Icons.people_rounded, 2, isActive: true),
                label: 'Members',
              ),
              BottomNavigationBarItem(
